...
namespace Microsoft.NetCore.Analyzers.Security
{
    ...
    public class DoNotHardcodeEncryptionKey : SourceTriggeredTaintedDataAnalyzerBase
    {
        internal static readonly DiagnosticDescriptor Rule = SecurityHelpers.CreateDiagnosticDescriptor(
            "CA3011",
            nameof(MicrosoftNetCoreSecurityResources.DoNotHardcodeEncryptionKey),
            nameof(MicrosoftNetCoreSecurityResources.DoNotHardcodeEncryptionKeyMessage),
            isEnabledByDefault: false,
            helpLinkUri: null); // TODO paulming: Help link.  https://github.com/dotnet/roslyn-analyzers/issues/1892

        protected override SinkKind SinkKind { get { return SinkKind.Key; } }
